...
> [!info]
> ***The [[#Aasimar Traits|revised version]] (from [[Mordenkainen's Monsters of the Multiverse]]) is listed first, and the [[#Aasimar Traits (legacy)|legacy]] (from [[Volo's Guide to Monsters]]) is listed second.***
...
*Standard scores are Charisma +2, and Wisdom, Constitution or Strength +1.*
### Creature Type
You are a Humanoid.
### Size
